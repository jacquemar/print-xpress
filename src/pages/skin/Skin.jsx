...
function Skin() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/list`)
      ...
      .then((data) => {
        setProductList(data);
        // Extraire les genres uniques des produits de type "Skin"
        const skinProducts = data.filter(
          (product) =>
            product.category.toLowerCase() === "skin" ||
            product.category.toLowerCase() === "skin adhésif"
        );
        const genres = [
          ...new Set(skinProducts.map((product) => product.gender)),
        ];
            ...
            <div className="relative rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="flex h-full flex-col items-center justify-center">
                <p className="mb-4 text-center font-thin">
                  Personnaliser vos Skin Adhésif
                </p>
                <svg
